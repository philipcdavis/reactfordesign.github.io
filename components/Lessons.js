  ...
  return (
    <LessonContainer pt={[4,5]} mb={5}>
      <Box sx={{maxWidth: 700}}mt={4} >
        ...
        <Text>This course is focused on the parts of React that are most useful for designers. Below is the list of videos that are currently available and those that are still in the works.</Text>
      </Box>
      <LessonCards />
